...
import com.example.eldiploma.presentation.pagesClassbook.groups.GroupsStore.Intent
import com.example.eldiploma.presentation.pagesClassbook.groups.GroupsStore.State
import com.example.eldiploma.presentation.pagesClassbook.groups.GroupsStore.Label
...
class GroupStoreFactory @Inject constructor(
    ...
    fun create(): GroupsStore =
        object : GroupsStore, Store<Intent, State, Label> by storeFactory.create(
            ...
            executorFactory = GroupStoreFactory::ExecutorImpl,
            reducer = ReducerImpl
        ) {}
