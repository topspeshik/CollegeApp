...
import com.example.eldiploma.presentation.pagesClassbook.students.StudentStore.Intent
import com.example.eldiploma.presentation.pagesClassbook.students.StudentStore.Label
import com.example.eldiploma.presentation.pagesClassbook.students.StudentStore.State
...
class StudentStoreFactory @Inject constructor(
    ...
    fun create(): StudentStore =
        object : StudentStore, Store<Intent, State, Label> by storeFactory.create(
            ...
            executorFactory = StudentStoreFactory::ExecutorImpl,
            reducer = ReducerImpl
        ) {}
