...
import com.example.eldiploma.presentation.pagesAttendance.attendanceList.AttendanceListStore.Intent
import com.example.eldiploma.presentation.pagesAttendance.attendanceList.AttendanceListStore.Label
import com.example.eldiploma.presentation.pagesAttendance.attendanceList.AttendanceListStore.State
...
interface AttendanceListStore : Store<Intent, State, Label> {
...
class AttendanceListStoreFactory @Inject  constructor(
    ...
    fun create(studentGroup: StudentGroup): AttendanceListStore =
        object : AttendanceListStore, Store<Intent, State, Label> by storeFactory.create(
